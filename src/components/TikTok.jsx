                    ...
                    <div className='flex flex-row h-5/6 '>
                        ...
                        <div className='w-1/6 h-full flex flex-col justify-end items-center p-2'>
                            <div className='absolute bottom-20'>
                                <span>
                                    <button className={`bg-[#f1f1f2] md:bg-transparent flex items-center justify-center h-12 w-12 rounded-full duration-300 ${isLiked ? 'text-red-500' : 'text-black'}`} onClick={handleLikeAndAddOneLike}><BsHeartFill fontSize={20} /></button>
